...
def main() -> None:
    parser = argparse.ArgumentParser(description="Predict triage labels for a CSV file using Transformer models.")
    ...
    print(f"Predicting {len(df)} rows using Transformer models...")
